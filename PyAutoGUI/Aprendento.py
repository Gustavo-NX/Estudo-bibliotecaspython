...
while distance > 0:
    pyautogui.drag(distance, 0, duration=0.1) #move para direita
    distance -= 5 #cada volta diminui o loop de tamanho então 200 - 5 = 195
    pyautogui.drag(0, distance, duration=0.1)#move para baixo
    pyautogui.drag(-distance, 0, duration=0.1)#move para esquerda
    distance -= 5 #cada volta diminui o loop de tamanho então 195 - 5 = 190 até chegar a 0
    pyautogui.drag(0, -distance, duration=0.1)#move para cima